...
.spin_img .sel { width: 140px; height: 170px; margin-left: 300px; top:0px; border:6px dashed blue; text-align:center; position:absolute; }
...
<div class="spin_img">
	...
	<div id="m">
		...
		<img src="img/로렉스3.jpg" alt="3">
		<img src="img/로렉스4.JPG" alt="4">
	</div>
	<br>
	<button>start</button>
</div>
